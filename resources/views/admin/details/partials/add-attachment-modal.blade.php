    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3"> 
                    <input type="hidden" class="form-control" name="attachmentRelatorSlug" value="detail" readonly required>
                    <input type="hidden" class="form-control" name="attachmentRelatorId" value="{{ $detail->orderDetailId }}" readonly required>
